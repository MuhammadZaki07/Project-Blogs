        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if (Auth()->user())
                        <x-nav-link :href="route('table.blog')" :active="request()->routeIs('table.blog')">
                            {{ __('Create Post') }}
                        </x-nav-link>
            ...
            @if (!Auth()->user())
                <div class="flex space-x-5 items-center">
                    <a href="{{ route('login') }}" class="font-bold text-white text-lg hover:text-slate-300">Login</a>
                    <a href="{{ route('register') }}"
                        class="font-bold text-white text-lg hover:text-slate-300">Register</a>
                </div>
            @else
