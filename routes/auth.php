...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/datausers/{id}', [Userscontroller::class, 'show'])->name('show.users');

    // Category
    Route::get('categories/tableCategory', [CategoryController::class, 'tableCategory'])->name('table.category');
    ...
    // Blogs
    Route::get('blogs/createBlog', [BlogsController::class, 'create'])->name('create.blog');
    Route::get('blogs/tableBlog', [BlogsController::class, 'index'])->name('table.blog');
    Route::post('blogs', [BlogsController::class, 'store'])->name('proccess.create.blog');
